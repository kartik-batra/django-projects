...
class AdminUserPost(admin.ModelAdmin):
    list_display = ['user_id',SocialAccount, 'description', 'attachments', 'insta_desc', 'insta_story', 'insta_first_comment',
...
class AdminCampaign(admin.ModelAdmin):
    list_display = ['post_id', 'name', 'date', 'description', 'status']

@admin.register(Schedule)
class AdminSchedule(admin.ModelAdmin):
    list_display = ['post_id', 'date_time', 'time_zone']
